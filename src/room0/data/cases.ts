...
export const CASES: CaseDef[] = [
  ...
  },
  {
    ...
    teaser: "KEY CONTROL ARCHIVE — ONE ENTRY WITHOUT A KEY.",
    evidenceIds: ["key-3317", "cabinet-3317", "routing-3314", "ext-3317", "line-3317"],
    relationIds: ["rel-3317-ext", "rel-routing-504"],
    hypothesisIds: ["hyp-case01"],
  },
  {
    id: "case02",
    index: "02",
    ...
    teaser: "LEGACY PROPERTY ARCHIVE — 1984 to 1992.",
    evidenceIds: ["audit-1017", "index-0212", "rebuild-0213", "index-0214", "photo-1987", "clock-0213", "mgr-01"],
    relationIds: ["rel-date-time"],
    hypothesisIds: ["hyp-case02"],
  },
